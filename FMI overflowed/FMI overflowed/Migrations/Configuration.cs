namespace FMI_overflowed.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                CreateUser(context, "Antonio@gmail.com", "123456", "System Administrator");
                CreateUser(context, "pesho@gmail.com", "1234", "Peter Ivanov");
                CreateUser(context, "merry@gmail.com", "1234", "Maria Petrova");
                CreateUser(context, "geshu@gmail.com", "1234", "George Petrov");

                CreateRole(context, "Administrators");
                AddUserToRole(context, "Antonio@gmail.com", "Administrators");
